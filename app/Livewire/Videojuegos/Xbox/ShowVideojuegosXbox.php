...
class ShowVideojuegosXbox extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function render()
    {
        $videojuegos = Videojuego::select('videojuegos.*', 'consolas.nombre as nombre_consola')
            ...
            ->where('consolas.nombre', 'like', 'Xbox%')
        ...
        return view('livewire.videojuegos.xbox.show-videojuegos', compact('videojuegos', 'generos', 'consolas'));
    }
    ...
    {
        $this->dispatch('confirmarBorrarVideojuegoXbox', $videojuego->id);
    }
