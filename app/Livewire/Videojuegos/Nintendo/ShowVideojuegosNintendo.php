...
namespace App\Livewire\Videojuegos\Nintendo;
...
class ShowVideojuegosNintendo extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function render()
    {
        $videojuegos = Videojuego::select('videojuegos.*', 'consolas.nombre as nombre_consola')
            ...
            ->where('consolas.nombre', 'like', 'Nintendo%')
        ...
        return view('livewire.videojuegos.nintendo.show-videojuegos', compact('videojuegos', 'generos', 'consolas'));
    }
    ...
    {
        $this->dispatch('confirmarBorrarVideojuegoNintendo', $videojuego->id);
    }
