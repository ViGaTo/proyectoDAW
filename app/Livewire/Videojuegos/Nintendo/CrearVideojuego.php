...
class CrearVideojuego extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.videojuegos.nintendo.crear-videojuego', compact('crearGeneros', 'crearConsolas'));
    }
    ...
    public function store(){
        ...
        $this->dispatch('videojuego-creado')->to('videojuegos.nintendo.show-videojuegos-nintendo');
