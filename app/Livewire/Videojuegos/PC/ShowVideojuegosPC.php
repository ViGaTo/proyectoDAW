...
namespace App\Livewire\Videojuegos\PC;
...
class ShowVideojuegosPC extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.videojuegos.pc.show-videojuegos', compact('videojuegos', 'generos', 'consolas'));
    }
    ...
    {
        $this->dispatch('confirmarBorrarVideojuegoPC', $videojuego->id);
    }
