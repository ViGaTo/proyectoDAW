...
class CrearVideojuego extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.videojuegos.pc.crear-videojuego', compact('crearGeneros', 'crearConsolas'));
    }
    ...
    public function store(){
        ...
        $this->dispatch('videojuego-creado')->to('videojuegos.p-c.show-videojuegos-p-c');
