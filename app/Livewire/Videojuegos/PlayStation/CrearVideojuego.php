...
class CrearVideojuego extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.videojuegos.playstation.crear-videojuego', compact('crearGeneros', 'crearConsolas'));
    }
    ...
    public function store(){
        ...
        $this->dispatch('videojuego-creado')->to('videojuegos.play-station.show-videojuegos-play-station');
